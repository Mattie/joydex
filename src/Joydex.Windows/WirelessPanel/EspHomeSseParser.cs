...
internal sealed class EspHomePressTracker
{
    private static readonly IReadOnlyDictionary<string, EspHomePanelButton> Buttons =
        new Dictionary<string, EspHomePanelButton>(StringComparer.Ordinal)
        {
            ...
            ["binary_sensor/Fast Mode"] = EspHomePanelButton.FastMode,
            ["binary_sensor/Side Chat"] = EspHomePanelButton.SideChat,
            ["binary_sensor/Voice Mute"] = EspHomePanelButton.VoiceMute,
            ["binary_sensor/Approve"] = EspHomePanelButton.Approve,
            ["binary_sensor/Reject"] = EspHomePanelButton.Reject,
            ["binary_sensor/New Task"] = EspHomePanelButton.NewTask,
            ["binary_sensor/Fork Task"] = EspHomePanelButton.ForkTask,
            ["binary_sensor/Previous Task"] = EspHomePanelButton.PreviousTask,
            ["binary_sensor/Submit"] = EspHomePanelButton.Submit,
            ["binary_sensor/Next Task"] = EspHomePanelButton.NextTask,
            ...
            ["binary_sensor-sidebar"] = EspHomePanelButton.PlanMode,
            ["binary_sensor-fast_mode"] = EspHomePanelButton.FastMode,
            ["binary_sensor-side_chat"] = EspHomePanelButton.SideChat,
            ["binary_sensor-voice_mute"] = EspHomePanelButton.VoiceMute,
            ["binary_sensor-approve"] = EspHomePanelButton.Approve,
            ["binary_sensor-reject"] = EspHomePanelButton.Reject,
            ["binary_sensor-new_task"] = EspHomePanelButton.NewTask,
            ["binary_sensor-fork_task"] = EspHomePanelButton.ForkTask,
            ["binary_sensor-previous_task"] = EspHomePanelButton.PreviousTask,
            ["binary_sensor-submit"] = EspHomePanelButton.Submit,
            ["binary_sensor-next_task"] = EspHomePanelButton.NextTask,
        };
