...
namespace VirpilCodexPad.Trace;
...
internal static class Program
{
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        using var window = new CooperativeWindow("Virpil Codex Pad Input Trace");
    ...
    {
        Console.WriteLine("VirpilCodexPad.Trace list");
        Console.WriteLine("VirpilCodexPad.Trace trace [--name text] [--instance-guid guid] [--seconds 60] [--axis-threshold 512] [--warmup-ms 250]");
    }
}
