...
The Codex command IDs, Windows default bindings, and keybinding precedence behavior in this repository were last validated on 2026-07-28 against:

- Windows package: `OpenAI.Codex 26.721.4979.0`
- Bundled app version: `26.721.41059`
- Codex build: `5848`
